    ...
    data() {
        return {
            ...
            pageData: [
                ...
                {
                    path: '/aiqiyi/animationsynthesis',
                    name: '电影综合排序',
                    params: {
                        channel_id: 1,
                        mode: 24,
                ...
                {
                    path: '/aiqiyi/animationnewonline',
                    name: '电影热播榜',
                    params: {
                        channel_id: 1,
                        mode: 11,
